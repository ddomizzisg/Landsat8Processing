                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="H3K Nez explorer">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Nez explorer <?php echo VERSION; ?></a></h3></p>
...
if (isset($_GET['view'])) {
    ...
    //echo FM_PATH;
    $file_url = FM_ROOT_URL . "/data/" . fm_convert_win((FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $file);
    $file_path = $path . '/' . $file;
        ...
        <div class="col-12">
            ...
            if($is_onlineViewer) {
                ...
                if (in_array($ext, array('gif', 'jpg', 'jpeg', 'png', 'bmp', 'ico', 'svg', 'webp', 'avif'))) {
                    echo '<p><img src="' . fm_enc(fm_convert_win($file_url)) . '" alt="" class="preview-img"></p>';
                }
            }elseif ($is_stl) {
                // Image content
                
                echo '<p><div id="stl_cont" style="height:500px;" src="' . fm_enc(fm_convert_win($file_url)) . '" alt="" class="preview-stl"></div></p>';
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Nez explorer<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Nez explorer">
...
<head>
    ...
    <style>
        ...
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        ...
        .message.error { border-color:red;color:red  }
        .message.alert { border-color:orange;color:orange  }
        .preview-img { min-height: 100px; max-width:100%;background:url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAKklEQVR42mL5//8/Azbw+PFjrOJMDCSCUQ3EABZc4S0rKzsaSvTTABBgAMyfCMsY4B9iAAAAAElFTkSuQmCC)  }
        .preview-stl { max-width:100%;background:url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAKklEQVR42mL5//8/Azbw+PFjrOJMDCSCUQ3EABZc4S0rKzsaSvTTABBgAMyfCMsY4B9iAAAAAElFTkSuQmCC)  }
...
<script>
    ...
    $(document).ready( function () {
        ...
        var stl_src = $("#stl_cont").attr( "src" );
        console.log(stl_src);
        console.log($("#stl_cont"));
        var stl_viewer=new StlViewer(document.getElementById("stl_cont"), { models: [ {id:0, filename:stl_src} ], canvas_height: "500px" });
    });
</script>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Nez explorer';      $tr['en']['AppTitle']           = 'File Manager';
