...
class ParserLansat8(File):
    ...
    def __init__(self, content, filename, db, usrToken, catalog):
        ...
        super(ParserLansat8, self).__init__(db)
    ...
    def parse(self):
        ...
        return {"Poligono":poligono,"usr_token":self.usrToken,"File_name":self.file_name,
                "Places":lugares,"Date":date,"Path":0,"Row":0,
                "Satelite":"Landsat8","Projection":projection,"Ellipsoid":ellipsoid,"catalog":self.catalog}
